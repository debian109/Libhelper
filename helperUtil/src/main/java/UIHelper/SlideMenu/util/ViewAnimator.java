package UIHelper.SlideMenu.util;
...
import UIHelper.SlideMenu.animation.FlipAnimation;
...
public class ViewAnimator<T extends Resourceble> {
    ...
    public void showMenuContent() {
        ...
        for (int i = 0; i < size; i++) {
            View viewMenu = activity.getLayoutInflater().inflate(R.layout.slide_menu_list_item, null);
            final int finalI = i;
