...
import UIHelper.RecyclerViewLib.Base.BaseLayoutRecycler;

public class RecyclerViewHelper extends BaseLayoutRecycler<RecyclerViewUI> {
    ...
    public RecyclerViewHelper(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
    ...
    @Override
    protected RecyclerViewUI createWrapperView(Context context, AttributeSet attrs) {
        RecyclerViewUI recyclerView= new RecyclerViewUI(context, attrs);
        //prevent id repeat
    ...
    public void setAdapter(AdapterRecycler adapter) {
