package UIHelper.RecyclerViewLib.Base;
...
public abstract class BaseLayoutRecycler<T extends View> extends LinearLayout {
    ...
    public BaseLayoutRecycler(Context context) {
        this(context, null);
    }

    public BaseLayoutRecycler(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }
