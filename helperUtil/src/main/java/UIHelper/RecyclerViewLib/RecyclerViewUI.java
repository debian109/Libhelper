...
package UIHelper.RecyclerViewLib;
...
import UIHelper.RecyclerViewLib.Exception.AdapterException;
import UIHelper.RecyclerViewLib.Listener.AdapterListener;
import UIHelper.RecyclerViewLib.Listener.SelectionListener;


public class RecyclerViewUI extends RecyclerView implements AdapterListener {
    ...
    private AdapterRecycler mMultiChoiceAdapter = null;
    private SelectionListener multiChoiceSelectionListener = null;
    ...
    public RecyclerViewUI(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    public void setAdapter(Adapter adapter) {
        ...
        if (adapter instanceof AdapterRecycler) {
            mMultiChoiceAdapter = ((AdapterRecycler) adapter);
    ...
    public void setMultiChoiceSelectionListener(SelectionListener multiChoiceSelectionListener) {
