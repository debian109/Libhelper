...
import UIHelper.RecyclerViewLib.Listener.Categorizable;
 ...
 */
public abstract class SectionedAdapter<T extends Categorizable> extends AdapterRecycler {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent,@ViewType int viewType) {
        switch (viewType) {
            ...
            case TYPE_ITEM: {
                return (ViewHolder) this.onCreateItemViewHolder(parent, viewType);
            }
            default: {
     ...
     */
    private static class SectionViewHolder extends AdapterRecycler.ViewHolder {
