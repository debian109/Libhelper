...
public class SwipeLayout extends ViewGroup {
    ...
    private SwipeListener mSlidingListener;
    ...
    public void setSlidingListener(SwipeListener listener) {
    ...
    interface SlidingPanelLayoutImpl {
        void invalidateChildRegion(SwipeLayout parent, View child);
    }

    static class SlidingPanelLayoutImplBase implements SlidingPanelLayoutImpl {
        public void invalidateChildRegion(SwipeLayout parent, View child) {
    ...
    class AccessibilityDelegate extends AccessibilityDelegateCompat {
        ...
        public void onInitializeAccessibilityNodeInfo(View host, AccessibilityNodeInfoCompat info) {
            ...
            info.setClassName(SwipeLayout.class.getName());
            info.setSource(host);
        ...
        public void onInitializeAccessibilityEvent(View host, AccessibilityEvent event) {
            ...
            event.setClassName(SwipeLayout.class.getName());
        }
    ...
    private class DisableLayerRunnable implements Runnable {
        ...
        @Override
        public void run() {
            if (mChildView.getParent() == SwipeLayout.this) {
