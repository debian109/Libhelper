...
public class ListQuickScroll extends View {
	...
	public ListQuickScroll(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
	}

	public ListQuickScroll(Context context, AttributeSet attrs) {
		super(context, attrs);
	}

	public ListQuickScroll(Context context) {
		super(context);
	}
