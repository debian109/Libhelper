...
public class ParallaxRelativeLayout extends RelativeLayout implements Parallaxable {
    ...
    public static class LayoutParams extends RelativeLayout.LayoutParams {
        ...
        LayoutParams(Context context, AttributeSet attributeSet) {
            ...
            TypedArray typedArray = context.obtainStyledAttributes(attributeSet, R.styleable.MaterialIntro_ParallaxLayout_Layout);
            parallaxFactor = typedArray.getFloat(R.styleable.MaterialIntro_ParallaxLayout_Layout_layout_parallaxFactor, parallaxFactor);
            typedArray.recycle();
        }
