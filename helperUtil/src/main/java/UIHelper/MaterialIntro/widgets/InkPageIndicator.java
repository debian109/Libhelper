package UIHelper.MaterialIntro.widgets;
...
public class InkPageIndicator extends View implements ViewPager.OnPageChangeListener, View.OnAttachStateChangeListener {
    ...
    public InkPageIndicator(Context context, AttributeSet attrs, int defStyle) {
        ...
        final TypedArray typedArray = getContext().obtainStyledAttributes(
                attrs, R.styleable.MaterialIntro_InkPageIndicator, defStyle, 0);

        dotDiameter = typedArray.getDimensionPixelSize(R.styleable.MaterialIntro_InkPageIndicator_dotDiameter, DEFAULT_DOT_SIZE * density);
        dotRadius = dotDiameter / 2;
        halfDotRadius = dotRadius / 2;
        gap = typedArray.getDimensionPixelSize(R.styleable.MaterialIntro_InkPageIndicator_dotGap, DEFAULT_GAP * density);
        animDuration = (long) typedArray.getInteger(R.styleable.MaterialIntro_InkPageIndicator_animationDuration, DEFAULT_ANIM_DURATION);
        animHalfDuration = animDuration / 2;
        unselectedColour = typedArray.getColor(R.styleable.MaterialIntro_InkPageIndicator_pageIndicatorColor, DEFAULT_UNSELECTED_COLOUR);
        int selectedColour = typedArray.getColor(R.styleable.MaterialIntro_InkPageIndicator_currentPageIndicatorColor, DEFAULT_SELECTED_COLOUR);
        typedArray.recycle();
