package UIHelper.MaterialIntro.adapter;
...
import UIHelper.MaterialIntro.parallax.ParallaxFragment;
...
public class SlideFragment extends ParallaxFragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.material_intro_fragment_slide, container, false);
    ...
    public String cantMoveFurtherErrorMessage() {
        return getString(R.string.material_intro_impassable_slide);
    }
