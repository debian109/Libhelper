 ...
 */
public class SectionedRecyclerViewAdapter1 extends MultiChoiceAdapter {
    ...
    public SectionedRecyclerViewAdapter1(Context context) {
        super(context);
     ...
     * - SectionedRecyclerViewAdapter1.VIEW_TYPE_HEADER
     * - SectionedRecyclerViewAdapter1.VIEW_TYPE_FOOTER
     * - SectionedRecyclerViewAdapter1.VIEW_TYPE_ITEM_LOADED
     * - SectionedRecyclerViewAdapter1.VIEW_TYPE_LOADING
     * - SectionedRecyclerViewAdapter1.VIEW_TYPE_FAILED
     * @param position position in the adapter
     * @return SectionedRecyclerViewAdapter1.VIEW_TYPE_HEADER, VIEW_TYPE_FOOTER,
