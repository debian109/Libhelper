...
public class ArrowDownloadButtonAnimation extends View {
    ...
    public ArrowDownloadButtonAnimation(Context context) {
        this(context, null);
    }

    public ArrowDownloadButtonAnimation(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ArrowDownloadButtonAnimation(Context context, AttributeSet attrs, int defStyleAttr) {
