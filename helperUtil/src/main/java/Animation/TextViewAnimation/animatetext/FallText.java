...
public class FallText extends HText {
    ...
    private float charTime    = 400; // Each character animation time 500ms
    private int   mostCount   = 20; // Up to 10 characters simultaneously Animation
    ...
    @Override protected void animateStart(CharSequence text) {
        ...
        // Calculate the total time animation
        ...
        for (int i = 0; i < maxLength; i++) {
            ...
            if (i < mOldText.length()) {
                ...
                if (move != -1) {
                    ...
                    //Demand point A (m, n) with respect to the point P (a, b) symmetric point B (x, y)
                    // (m+x)/2=a ,x=2a-m
                    // (n+y)/2=b ,y=2b-n
