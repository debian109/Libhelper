...
public class SkyView extends SurfaceView implements SurfaceHolder.Callback {
	...
	private Context activity; // Link to the parent activity
	...
	private void setup() {
		...
		// Set the state
		fireworksGenerationMode = MODE_CONTINUOUS;
	...
	private class FireworksThread extends Thread {
		...
		public void run() {
			...
			while (threadIsRunning) {
				...
				if (fireworksGenerationMode == MODE_CONTINUOUS) {
