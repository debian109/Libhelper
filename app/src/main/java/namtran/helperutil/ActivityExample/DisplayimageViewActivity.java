...
import LoadImage.BasicLoadImage.LoadingLargeImage;
import namtran.helperutil.Adapter.AdapterBasic;
import namtran.helperutil.Adapter.AdapterBasic1;
 ...
 */
public class DisplayimageViewActivity extends BaseActivity {



    private LruCache<String,Bitmap> mMemoryCache;
    ImageView displayLargeImage;
    ListView listView1;
    GridView gridView;
    ...
    Integer[] list = new Integer[]{R.drawable.argentina,R.drawable.australia,R.drawable.belgium,R.drawable.brazil
            ,R.drawable.cambodia,R.drawable.canada,R.drawable.china,R.drawable.czech_republic,R.drawable.england,R.drawable.indonesia
            ,R.drawable.israel,R.drawable.italy,R.drawable.japan,R.drawable.korea,R.drawable.poland,R.drawable.portugal,R.drawable.spain
            ,R.drawable.thailand,R.drawable.turkey,R.drawable.ukraine,R.drawable.united_states,R.drawable.vietnam,R.drawable.argentina,R.drawable.australia,R.drawable.belgium,R.drawable.brazil
            ,R.drawable.cambodia,R.drawable.canada,R.drawable.china,R.drawable.czech_republic,R.drawable.england,R.drawable.indonesia
            ,R.drawable.israel,R.drawable.italy,R.drawable.japan,R.drawable.korea,R.drawable.poland,R.drawable.portugal,R.drawable.spain
            ,R.drawable.thailand,R.drawable.turkey,R.drawable.ukraine,R.drawable.united_states,R.drawable.vietnam,R.drawable.argentina,R.drawable.australia,R.drawable.belgium,R.drawable.brazil
            ,R.drawable.cambodia,R.drawable.canada,R.drawable.china,R.drawable.czech_republic,R.drawable.england,R.drawable.indonesia
            ...
            ,R.drawable.cambodia,R.drawable.canada,R.drawable.china,R.drawable.czech_republic,R.drawable.england,R.drawable.indonesia
            ,R.drawable.israel,R.drawable.italy,R.drawable.japan,R.drawable.korea,R.drawable.poland,R.drawable.portugal,R.drawable.spain
            ,R.drawable.thailand,R.drawable.turkey,R.drawable.ukraine,R.drawable.united_states,R.drawable.vietnam};
    ...
    protected View initContentView() {
        return getView(R.layout.displayimageview_layout);
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        displayLargeImage = (ImageView) findViewById(R.id.displayLargeImage);
       // listView = (ListView) findViewById(R.id.listView);
        listView1 = (ListView) findViewById(R.id.listview1);
       // gridView = (GridView) findViewById(R.id.gridView);
        Bitmap bitmap = BitmapFactory.decodeResource(getResources(),R.drawable.balloon);
        displayLargeImage.setImageBitmap(LoadingLargeImage.decodeSampledBitmapFromResource(getResources(), R.drawable.vietnam, 400, 400));

        AdapterBasic adapterBasic = new AdapterBasic(this,R.layout.adapterbasic_layout,list);
        //listView.setAdapter(adapterBasic);
        //gridView.setAdapter(adapterBasic);

        String sdcardPath = Environment.getExternalStorageDirectory().getAbsolutePath();
        /*boolean path = Environment.getExternalStorageState().contains("Download");*/
        ...
        ExtensionsNameFilter extensionsNameFilter = new ExtensionsNameFilter(IMAGE_FILTER);
        for (int i=0;i<files.length;i++)
        {
            if(extensionsNameFilter.accept(file,files[i].getPath()) == true)
                    {
                            listfile.add(files[i].getPath());
                    }
        }*/

        File abc = Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS);

        //ArrayList<String> files = FileUtil.getAllFileExtensionFilterFromDir(abc, IMAGE_FILTER);

        //Log.d("1", String.valueOf(files.size()));

        List<File> pathfiles1 = FileUtil.getAllFileExtensionFilterFromDir(abc, IMAGE_FILTER);

        //ArrayList<String> pathfiles = Convert.convertArrayStringToArrayList(imageThumbUrls);

        AdapterBasic1 adapterBasic2 = new AdapterBasic1(this,R.layout.adapterbasic_layout,pathfiles1);
        listView1.setAdapter(adapterBasic2);
    }
