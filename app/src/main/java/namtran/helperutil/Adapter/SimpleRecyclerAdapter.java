...
public class SimpleRecyclerAdapter extends RecyclerView.Adapter<SimpleRecyclerAdapter.VersionViewHolder> {
    ...
    public static List<String> homeActivitiesList;
    public static List<String> homeActivitiesSubList;
    Context context;
    ...
    public void setHomeActivitiesList(Context context) {
        ...
        homeActivitiesList = Convert.convertArrayStringToList(listArray);
        homeActivitiesSubList = Convert.convertArrayStringToList(subTitleArray);
    }
